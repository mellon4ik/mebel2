...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_image_main_menu'] = $this->language->get('entry_image_main_menu');
		$data['entry_image_category_wall'] = $this->language->get('entry_image_category_wall');
		$data['entry_image_subcategory_list'] = $this->language->get('entry_image_subcategory_list');
<<<<<<< HEAD
		$data['entry_image_top_menu'] = $this->language->get('entry_image_top_menu');
=======
>>>>>>> 5b727248a58fafe0cd14b54a2ca2e114a8ed3dd5
		...
		if (isset($this->error['image_main_menu'])) {
			$data['error_image_main_menu'] = $this->error['image_main_menu'];
		} else {
			$data['error_image_main_menu'] = '';
		}

		if (isset($this->error['image_category_wall'])) {
			$data['error_image_category_wall'] = $this->error['image_category_wall'];
		} else {
			$data['error_image_category_wall'] = '';
		}

		if (isset($this->error['image_subcategory_list'])) {
			$data['error_image_subcategory_list'] = $this->error['image_subcategory_list'];
		} else {
			$data['error_image_subcategory_list'] = '';
		}

<<<<<<< HEAD
		if (isset($this->error['image_top_menu'])) {
			$data['error_image_top_menu'] = $this->error['image_image_top_menu'];
		} else {
			$data['error_image_top_menu'] = '';
		}
...
>>>>>>> 5b727248a58fafe0cd14b54a2ca2e114a8ed3dd5
		...
		if (isset($this->request->post['config_google_plus'])) {
			$data['config_google_plus'] = $this->request->post['config_google_plus'];
		} else {
		...
		if (isset($this->request->post['config_image_main_menu_width'])) {
			$data['config_image_main_menu_width'] = $this->request->post['config_image_main_menu_width'];
		} else {
			$data['config_image_main_menu_width'] = $this->config->get('config_image_main_menu_width');
		}

		if (isset($this->request->post['config_image_main_menu_height'])) {
			$data['config_image_main_menu_height'] = $this->request->post['config_image_main_menu_height'];
		} else {
			$data['config_image_main_menu_height'] = $this->config->get('config_image_main_menu_height');
		}

		if (isset($this->request->post['config_image_category_wall_width'])) {
			$data['config_image_category_wall_width'] = $this->request->post['config_image_category_wall_width'];
		} else {
			$data['config_image_category_wall_width'] = $this->config->get('config_image_category_wall_width');
		}

		if (isset($this->request->post['config_image_category_wall_height'])) {
			$data['config_image_category_wall_height'] = $this->request->post['config_image_category_wall_height'];
		} else {
			$data['config_image_category_wall_height'] = $this->config->get('config_image_category_wall_height');
		}

		if (isset($this->request->post['config_image_subcategory_list_width'])) {
			$data['config_image_subcategory_list_width'] = $this->request->post['config_image_subcategory_list_width'];
		} else {
			$data['config_image_subcategory_list_width'] = $this->config->get('config_image_subcategory_list_width');
		}

		if (isset($this->request->post['config_image_subcategory_list_height'])) {
			$data['config_image_subcategory_list_height'] = $this->request->post['config_image_subcategory_list_height'];
		} else {
			$data['config_image_subcategory_list_height'] = $this->config->get('config_image_subcategory_list_height');
		}

<<<<<<< HEAD
		if (isset($this->request->post['config_image_top_menu_width'])) {
			$data['config_image_top_menu_width'] = $this->request->post['config_image_top_menu_width'];
		} else {
			$data['config_image_top_menu_width'] = $this->config->get('config_image_top_menu_width');
		}

		if (isset($this->request->post['config_image_top_menu_height'])) {
			$data['config_image_top_menu_height'] = $this->request->post['config_image_top_menu_height'];
		} else {
			$data['config_image_top_menu_height'] = $this->config->get('config_image_top_menu_height');
		}
...
>>>>>>> 5b727248a58fafe0cd14b54a2ca2e114a8ed3dd5
	...
	protected function validate() {
		...
		if (!$this->request->post['config_image_main_menu_width'] || !$this->request->post['config_image_main_menu_height']) {
			$this->error['image_main_menu'] = $this->language->get('error_image_main_menu');
		}

		if (!$this->request->post['config_image_category_wall_width'] || !$this->request->post['config_image_category_wall_height']) {
			$this->error['image_category_wall'] = $this->language->get('error_image_category_wall');
		}

		if (!$this->request->post['config_image_subcategory_list_width'] || !$this->request->post['config_image_subcategory_list_height']) {
			$this->error['image_subcategory_list'] = $this->language->get('error_image_subcategory_list');
		}

<<<<<<< HEAD
		if (!$this->request->post['config_image_top_menu_width'] || !$this->request->post['config_image_top_menu_height']) {
			$this->error['image_top_menu'] = $this->language->get('error_image_top_menu');
		}
