...
=======
        //proposition
        if(isset($this->request->get['product_id']) && ($this->config->get('proposition_status') && $this->config->get('proposition_status') == 1)) {
            $data['entry_proposition_name'] = $this->language->get('entry_proposition_name');
            $data['entry_proposition_product'] = $this->language->get('entry_proposition_product');

            $data['button_proposition_add'] = $this->language->get('button_proposition_add');

            $data['text_proposition_product_name'] = $this->language->get('text_proposition_product_name');
            $data['text_proposition_price'] = $this->language->get('text_proposition_price');
            $data['text_proposition_price_included'] = $this->language->get('text_proposition_price_included');
            $data['text_proposition_amount'] = $this->language->get('text_proposition_amount');
            $data['text_proposition_sort'] = $this->language->get('text_proposition_sort');
            $data['text_proposition_sum'] = $this->language->get('text_proposition_sum');
...
=======
        ...
        if(isset($this->request->get['product_id']) && ($this->config->get('proposition_status') && $this->config->get('proposition_status') == 1)) {
            ...
            $data['propositions'] = $this->model_catalog_product->getPropositions($this->request->get['product_id']);
...
=======
    ...
    public function save_proposition() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            $this->load->model('catalog/product');
            $this->model_catalog_product->savePropositions($this->request->get['product_id'], $this->request->post);
            echo json_encode(array('status'=> true, 'message' => $this->language->get('text_proposition_save_success')));
        }
        else {
