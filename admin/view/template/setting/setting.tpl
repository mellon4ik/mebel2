        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone-2"><?php echo $entry_telephone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_2" value="<?php echo $config_telephone_2; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone-2" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone-3"><?php echo $entry_telephone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_3" value="<?php echo $config_telephone_3; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone-3" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-plus"><?php echo $entry_google_plus; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_google_plus" value="<?php echo $config_google_plus; ?>" placeholder="<?php echo $entry_google_plus; ?>" id="input-google-plus" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-main_menu"><?php echo $entry_image_main_menu; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_main_menu_width" value="<?php echo $config_image_main_menu_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-main_menu" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_main_menu_height" value="<?php echo $config_image_main_menu_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_main_menu) { ?>
                    <div class="text-danger"><?php echo $error_image_main_menu; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-category_wall"><?php echo $entry_image_category_wall; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_category_wall_width" value="<?php echo $config_image_category_wall_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-category_wall" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_category_wall_height" value="<?php echo $config_image_category_wall_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_category_wall) { ?>
                    <div class="text-danger"><?php echo $error_image_category_wall; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-subcategory_list"><?php echo $entry_image_subcategory_list; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_subcategory_list_width" value="<?php echo $config_image_subcategory_list_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-subcategory_list" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_subcategory_list_height" value="<?php echo $config_image_subcategory_list_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_subcategory_list) { ?>
                    <div class="text-danger"><?php echo $error_image_subcategory_list; ?></div>
                  <?php } ?>
                </div>
              </div>
<<<<<<< HEAD
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-top-menu"><?php echo $entry_image_top_menu; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_top_menu_width" value="<?php echo $config_image_top_menu_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-top-menu" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_top_menu_height" value="<?php echo $config_image_top_menu_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_top_menu) { ?>
                    <div class="text-danger"><?php echo $error_image_top_menu; ?></div>
                  <?php } ?>
                </div>
              </div>
=======
