...
<<<<<<< HEAD
                          <option src="<?php echo $option_value['option_value_image']; ?>" src-colorbox="<?php echo $option_value['option_value_image_colorbox']; ?>" value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
=======
                    ...
                    <div id="input-option<?php echo $option['product_option_id']; ?>">
                      <?php foreach ($option['product_option_value'] as $option_value) { ?>
                        <div class="radio">
                          <label>
<<<<<<< HEAD
                              <input class="thumb" src="<?php echo $option_value['option_value_image']; ?>" src-colorbox="<?php echo $option_value['option_value_image_colorbox']; ?>" type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>"/>
=======
