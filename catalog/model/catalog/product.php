	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
                ...
                'category_list'    => $query->row['category_list']
			);
		} else {
			return false;
		}
