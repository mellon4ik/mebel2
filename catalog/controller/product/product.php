...
=======
        ...
        $this->document->addScript('catalog/view/javascript/jquery/jquery.json-2.4.min.js');
...
<<<<<<< HEAD
=======
			$data['text_proposition_option'] = $this->language->get('text_proposition_option');
			$data['error_proposition_options'] = $this->language->get('error_proposition_options');
>>>>>>> 5b727248a58fafe0cd14b54a2ca2e114a8ed3dd5
			...
			$data['tab_all'] = $this->language->get('tab_all');
...
>>>>>>> 5b727248a58fafe0cd14b54a2ca2e114a8ed3dd5
	...
	public function review() {
		...
		foreach ($results as $result) {
            $review_replies = $this->model_catalog_review->getReviewReply($this->request->get['product_id'], $result['review_id']);

            $reply = array();
            foreach($review_replies as $review_reply) {
                $reply[] = array(
                    'review_id' => $review_reply['review_id'],
                    'author' => $review_reply['author'],
                    'text' => nl2br($review_reply['text']),
                    'rating' => (int)$review_reply['rating'],
                    'date_added' => date($this->language->get('date_format_short'), strtotime($review_reply['date_added']))
                );
            }
